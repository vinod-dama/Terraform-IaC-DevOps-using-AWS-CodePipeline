...
sudo echo '<!DOCTYPE html> <html> <body style="background-color:rgb(260, 220, 220);"> <h1>Welcome to Building AWS infra across multi env via CodePipeline - APP-1</h1> <p>Terraform Demo</p> <p>Application Version: V1</p> </body></html>' | sudo tee /var/www/html/app1/index.html
